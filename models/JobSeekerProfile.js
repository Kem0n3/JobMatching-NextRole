...
const CategoryExperienceSchema = new mongoose.Schema({
    ...
    // category_text: { type: String, required: true }, // Optional: store text for easier display if needed, but can be looked up
...
const JobSeekerProfileSchema = new mongoose.Schema({
    ...
    desiredJobTypes: { // Array of job type strings
        ...
        enum: ['Full-time', 'Part-time', 'Contract', 'Internship'] // Ensure values are from this list
    },
