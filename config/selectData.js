...
//skills
const skillsList = [     // Programming Languages
...
const jobPostJobTypesList = [ // Specific for job postings, can be same as seeker's desiredJobTypes
    { id: "Full-time", text: "Full-time" },
    { id: "Part-time", text: "Part-time" },
    { id: "Contract", text: "Contract" },
    { id: "Internship", text: "Internship" }
...
module.exports = {
    ...
    jobTypeList: jobPostJobTypesList, // Use this for job postings (can rename if seeker has a different list)
    careerLevelsList
};