...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let applicationStatusCountsFromEJS = {}; // Renamed to avoid conflict
    ...
    if (applicationChartCtx && applicationStatusCountsFromEJS && Object.keys(applicationStatusCountsFromEJS).length > 0) {
        ...
        statusOrder.forEach(statusKey => {
            if (applicationStatusCountsFromEJS[statusKey]) {
                ...
                // This line directly uses the color passed from the backend:
            ...
            new Chart(applicationChartCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: data,
                        backgroundColor: backgroundColors, // Used here
                    ...
                    plugins: {
                        legend: {
                            ...
                            labels: {
                                padding: 15,
                                font: {
                                    family: "'Inter', sans-serif", // Match your main font
                                    size: 13
                                },
                                color: '#394867' // Use your primary text color
                            }
                        },
                        title: {
                            display: false,
    ...
    } else if (applicationChartCtx) { // Canvas exists but no data
        const chartContainer = document.querySelector('.application-tracker .chart-container');
